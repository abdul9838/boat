            ...
            <form className=" text-white mt-10 w-full">
                <div className=" flex flex-col lg:flex-row gap-8 lg:justify-between">
                    <div className=" w-full">
                        <input
                            ...
                            className=" bg-transparent border-2 border-white rounded-md outline-none w-full px-4 py-3"
                        />
                    </div>
                    <div className=" w-full">
                        <input
                ...
                <div className="mt-4">
                    <textarea
                        ...
                        className=" bg-transparent border-2 border-white rounded-md outline-none px-4 py-3 w-full"
                    ></textarea>
                </div>
